...
export class D220531 {
	...
	init() {
		...
		this.print = new Databox(document.querySelector('#print')).init();
...
export function d220531() {
	const error = new Databox(document.querySelector('#d220531 #error')).init();
	try {
		...
		const timestamp = new Databox(document.querySelector('#d220531 #legs #timestamp')).init();
